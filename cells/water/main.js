...
function updateSand() {
    for(let i = cells.length - 1; i >= 0; i--) {
        for(let j = cells[i].length - 1; j >= 0; j--) {
            if(cells[i][j] == 1) {
                if(i < cells.length - 1 && cells[i+1] != undefined && cells[i+1][j] != undefined && cells[i+1][j] == 0) {
                    cells[i][j] = 0;
                    cells[i+1][j] = 1;
                }
                else if(i < cells.length - 1 && j < cells[i].length - 1 && cells[i+1] != undefined && cells[i+1][j+1] != undefined && cells[i+1][j+1] == 0) {
                    cells[i][j] = 0;
                    cells[i+1][j+1] = 1;
                }
                else if(i < cells.length - 1 && j > 0 && cells[i-1] != undefined && cells[i+1][j-1] != undefined && cells[i+1][j-1] == 0) {
                    cells[i][j] = 0;
                    cells[i+1][j-1] = 1;
                }
                else if(j < cells[i].length - 1 && cells[i] != undefined && cells[i][j+1] != undefined && cells[i][j+1] == 0) {
                    cells[i][j] = 0;
                    cells[i][j+1] = 1;
                }
                else if(j > 0 && cells[i] != undefined && cells[i][j-1] != undefined && cells[i][j-1] == 0) {
                    cells[i][j] = 0;
                    cells[i][j-1] = 1;
                }
            }
